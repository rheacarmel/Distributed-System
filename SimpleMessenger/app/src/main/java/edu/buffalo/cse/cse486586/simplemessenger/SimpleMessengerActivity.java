            ...
            ServerSocket serverSocket = sockets[0];
                ...
                try {
                    while(true) {
                        ...
                        DataInputStream ir = new DataInputStream(new BufferedInputStream(clientSocket.getInputStream()));   //https://www.javatpoint.com/java-socket-getinputstream-method  and  https://docs.oracle.com/javase/tutorial/networking/sockets/readingWriting.html
                        String msg = " ";

                        msg = ir.readUTF();   //asked professor Ko about the permission to use readUTF
                        publishProgress(msg);
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                ds.writeUTF(msgToSend);  //asked professor Ko permission to use writeUTF
                ds.flush();
